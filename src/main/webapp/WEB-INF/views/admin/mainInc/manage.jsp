			...
			<div class="card-body">
				<form method="post">
					...
					<br /> <b>대표 이미지</b> <br /> <img
						...
						width="70px" /> <br /> <br /> <b>가게이름</b> <br /> ${store.name}<br />
					<br /> <b>주소</b><br /> ${store.address}<br /> <br /> <b>대표번호</b><br />
					<input type="tel" value="${store.phone}" id="phone" name="phone"
						placeholder="010-1234-5678" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}"><br />
						<br /> <b>짐 보관 갯수</b><br /> 
						<div style="color:gray">* 최대 100개까지</div>
						<input type="number" id="tentacles" name="tentacles" min="1" max="100"
						value="${store.luggage}" name="luggage"> 개<br /> 
						
						<br />

							<hr /> <br>
								<h5>영업시간</h5> <br /> <b>월~금</b> : <input type="time"
								value="${store.manage_week_time}" name="manage_week_time">
									~ <input type="time" value="${store.manage_week_time}"
									name="manage_week_time"> <br /> <br /> <b>토요일</b> : <input
										type="time" value="${store.manage_sat_time}"
										name="manage_sat_time"> ~ <input type="time"
											value="${store.manage_sat_time}" name="manage_sat_time">
												...
												value="${store.manage_sun_time}" name="manage_sun_time">
													~ <input type="time" value="${store.manage_sun_time}"
													name="manage_sun_time"> <br /> <br />
														<hr /> <br>
															<h5>공지사항 안내</h5> <br /> <textarea class="form-control"
																id="exampleFormControlTextarea1" rows="3" name="notice">${store.notice}</textarea>
															<br /> <br />
															<hr /> <br />
				</form>
